...
<form:form method="post" action="${action}" modelAttribute="user" enctype="multipart/form-data">
    ...
    <c:choose>
        ...
        <c:when test="${isActive = false}">
            ...
            <div class="form-floating mb-3 mt-3">
                <form:input type="text" class="form-control" path="username" name="username" id="username" placeholder="Tên đăng nhập" />
            ...
            <div class="form-floating mb-3 mt-3">
                <form:input type="password" class="form-control" path="rePassword" id="rePassword" placeholder="Nhập lại mật khẩu" name="rePassword" />
                <label for="name">Nhật lại mật khẩu</label>
            </div>
            <!-- Fields for Admin -->
